...
export const SET_USER_IS_AUTH = createRequestTypes('SET_USER_IS_AUTH');
const setUserIsAuth = {
...
export const SET_USER_LOGIN = createRequestTypes('SET_USER_LOGIN');
const setUserLogn = {
...
export const SET_USER_REGISTRATION = createRequestTypes(
